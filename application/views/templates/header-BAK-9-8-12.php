...
<div class="menu">
  ...
  <div class="tab" style="width:160px;"><a href="<?php echo $baseURL; ?>/backcountry" style="" title="Backcountry.com Deals, Coupons and Sales">Backcountry.com Deals</a></div>
  <div class="tab" style="width:100px;"><a href="<?php echo $baseURL; ?>/rei" style="" title="REI Deals, Coupons and Sales">REI Deals</a></div>
  <div class="tab" style="width:140px;"><a href="<?php echo $baseURL; ?>/moosejaw" style="" title="Moosejaw.com Deals, Coupons and Sales">Moosejaw.com Deals</a></div>
  <div class="tab" style="width:142px;"><a href="<?php echo $baseURL; ?>/campsaver" style="" title="Campsaver.com Deals, Coupons and Sales">Campsaver.com Deals</a></div>
  <div class="tab" style="width:130px;border-right:1px solid #aaa;"><a href="http://thedeal.gearcompare.com" target="_blank" titel="Outdoor Gear Deals Blog">The Deal Blog</a></div>
</div>
...
<div style="border-left: 1px solid #aaa;border-right: 1px solid #aaa;border-bottom: 1px solid #aaa;">
  <ul class="megamenu">
    ...
    <li style="width:85px;"> <a href="<?php echo $baseURL; ?>/category/hiking-camping-gear" style="">Hike/Camp</a>

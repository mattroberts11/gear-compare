...
<?php 
	...
	if (!isset($page)){
 		echo '<meta name="description" content="'.$title.' and outdoor gear on sale. Outdoor gear coupons, discounts, sales and offers you won\'t find any place else! | GearCompare.com"/>';
 }else{
...
<body class="h-droid b-arial light">
<a name="top"></a>
<div id="wrapper">
<!-- BEGIN TOP NAV -->
<div id="topnav_wrap">
  <div class="topnav">
    <div class="menu-top-menu-container">
      <ul id="menu-top-menu" class="menu">
        ...
        <li id="menu-item-119" class="star menu-item menu-item-type-taxonomy menu-item-object-category menu-item-119"><a href="http://thedeal.gearcompare.com/category/inspiration/">Inspiration</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="menu">
  ...
  <div class="tab" style="width:140px;"><a href="#" style="">Backcountry.com</a></div>
  <div class="tab" style="width:160px;"><a href="#" style="">Backcountry.com Deals</a></div>
  <div class="tab" style="width:100px;"><a href="#" style="">REI Deals</a></div>
  <div class="tab" style="width:140px;"><a href="#" style="">Moosejaw.com Deals</a></div>
  <div class="tab" style="width:142px;"><a href="#" style="">Campsaver.com Deals</a></div>
  <div class="tab" style="width:130px;border-right:1px solid #aaa;"><a href="http://thedeal.gearcompare.com" target="_blank">The Deal Blog</a></div>
</div>
  ...
  <ul class="megamenu">
    <li style="width:120px;"> <a href="<?php echo $baseURL; ?>/category/mens-clothing" style="">Men's Clothing</a>
      <div style="width: 820px;z-index:100;float:left;background:#666;">
        ...
        <div style="float:left;padding:10px;">
          <h3><a href="<?php echo $baseURL; ?>/category/mens-clothing/mens-accessories/?cat=Men's Clothing&subcat=Men's Accessories">Other</a></h3>
      ...
      <div style="width: 810px;z-index:100;background:#666;">
        ...
        <div style="float:left;padding:10px;">
          ...
          <p> <a href="<?php echo $baseURL; ?>/group/bike/complete-bikes/downhill-freeride-bikes/?cat=Bike&subcat=Complete Bikes&group=Road Bikes">Road Bikes</a><br/>
            <!--<a href="<?php echo $baseURL; ?>/group/bike/complete-bikes/allmountain-trail-bikes">All-Mountain &amp; Trail Bikes</a><br/>-->
            <!--<a href="<?php echo $baseURL; ?>/group/bike/complete-bikes/commuter-bikes">Commuter Bikes</a><br/>-->
    ...
    <li> <a href="<?php echo $baseURL; ?>/category/hiking-camping-gear" style="">Hike/Camp</a>
    ...
    <li style="width:75px;"> <a href="<?php echo $baseURL; ?>/category/climb" style="">Other</a>
      <div style="width: 350px;z-index:100;background:#666;">
        ...
        <div style="float:left;padding:10px;">
          ...
          <p> <!--<a href="<?php echo $baseURL; ?>/subcat/paddle/kayaks/?cat=Paddle&subcat=Kayaks">Kayaks</a><br/>-->
            ...
            <a href="<?php echo $baseURL; ?>/subcat/paddle/stand-up-paddleboards/?cat=Paddle&subcat=Stand-Up Paddle&group=Stand-Up Paddleboards">Stand-Up Paddleboards</a><br/>-->
    ...
    <li style="width:113px;"> <a href="<?php echo $baseURL; ?>/brand/the-north-face">SHOP BY BRAND</a>

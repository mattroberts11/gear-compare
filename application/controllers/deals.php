...
class Deals extends CI_Controller {
	...
	public function detail($SKU)
	{
        ...
        $data['altrec_comp'] = $this->compare_model->compare_altrec($data['products_item']['BrandName'], $data['products_item']['ProductName']);
        $data['altrec_outlet_comp'] = $this->compare_model->compare_altrec_outlet($data['products_item']['BrandName'], $data['products_item']['ProductName']);
        $data['campsaver_comp'] = $this->compare_model->compare_campsaver($data['products_item']['BrandName'], $data['products_item']['ProductName']);
        $data['dog_comp'] = $this->compare_model->compare_campsaver($data['products_item']['BrandName'], $data['products_item']['ProductName']);
        $data['moosejaw_comp'] = $this->compare_model->compare_moosejaw($data['products_item']['BrandName'], $data['products_item']['ProductName']);
        $data['rei_comp'] = $this->compare_model->compare_rei($data['products_item']['BrandName'], $data['products_item']['ProductName']);
        
        $data['related'] = $this->products_model->get_related_products($data['products_item']['Category'], $data['products_item']['SubCategory'], $data['products_item']['ProductGroup']);
